...
<body class="sb-nav-fixed">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <br>
            <form name="form3" method="post" action="report_order_no.php">
                <div class="row">
                    <div class="col-sm-2">
                ...
                <tbody>
                    <?php
                     ...
                     if(($date1 != "") && ($date2 != "") ){
                         ...
                         $sql = "select * from tb_order  where order_status='0' and date BETWEEN '$date1' and '$date2' ORDER BY date DESC ";
                     }else{
                         $sql =  "select * from tb_order where order_status='0'  order by date DESC";
                     }
